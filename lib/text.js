...
const menu = (prefix, pushname) => {
 ...
 var tim = new Date().getHours(), salam = tim > 2 && tim < 4 ? "Pagi 🌅" : tim < 06 ? "Pagi 🏞" : tim < 10 ? "siang 🏙" : tim < 15 ? "Sore 🌇" : tim < 18 ? "Malam 🌃" : "Malam 🌌"

 let p = 0

 return ` *sh¡ro-BOT*

Selamat ${salam} *${pushname}*,Semoga harimu Suram :)
 ...
 *ᗒ* Invite link shiro | Discord
┏━━━━━━━━━━━━━━━━━━━━━━━━
    ┃https://discord.com/oauth2/authorize?client_id=903364186652966942&permissions=37088832&scope=bot
┗━━━━━━━━━━━━━━━━━━━━━━━━
...
const listCode = `Kode bahasa tersebut tidak ada\n  Code       Bahasa\n    sq        Albanian\n    ar        Arabic\n    hy        Armenian\n    ca        Catalan\n    zh        Chinese\n    zh-cn     Chinese (China)\n    zh-tw     Chinese (Taiwan)\n    zh-yue    Chinese (Cantonese)\n    hr        Croatian\n    cs        Czech\n    da        Danish\n    nl        Dutch\n    en        English\n    en-au     English (Australia)\n    en-uk     English (United Kingdom)\n    en-us     English (United States)\n    eo        Esperanto\n    fi        Finnish\n    fr        French\n    de        German\n    el        Greek\n    ht        Haitian Creole\n    hi        Hindi\n    hu        Hungarian\n    is        Icelandic\n    id        Indonesian\n    it        Italian\n    ja        Japanese\n    ko        Korean\n    la        Latin\n    lv        Latvian\n    mk        Macedonian\n    no        Norwegian\n    pl        Polish\n    pt        Portuguese\n    pt-br     Portuguese (Brazil)\n    ro        Romanian\n    ru        Russian\n    sr        Serbian\n    sk        Slovak\n    es        Spanish\n    es-es     Spanish (Spain)\n    es-us     Spanish (United States)\n    sw        Swahili\n    sv        Swedish\n    ta        Tamil\n    th        Thai\n    tr        Turkish\n    vi        Vietnamese\n    cy        Welsh\n    `
...
const mess = {
    ...
    botAdmin: 'perintah ini hanya dapat digunakan jika bot adalah admin',
